...
public class FinishBillFragment extends Fragment implements ProductClickListener {
        ...
        customerIdCall.enqueue(new Callback<CustomerIdResponse>() {
            ...
            public void onResponse(Call<CustomerIdResponse> call, Response<CustomerIdResponse> response) {
                if(response.isSuccessful()){
                    ...
                    Call<List<Bill>> billCall = billService.getBillOfCustomerID(customerId, BillStatus.DaGiao);
                        ...
                        public void onResponse(Call<List<Bill>> call, Response<List<Bill>> response) {
                            if (response.isSuccessful()) {
                                ...
                                if (lstBill.isEmpty()) {
                                    ...
                                    rcv_finishBill.setVisibility(View.GONE);
                                } else {
                                    ln_notBill.setVisibility(View.GONE);
                                    rcv_finishBill.setVisibility(View.VISIBLE);
                                }
                            } else {
                                ln_notBill.setVisibility(View.VISIBLE);
                                rcv_finishBill.setVisibility(View.GONE);
    ...
    private void AnhXa(View view){
        ...
        rcv_finishBill = view.findViewById(R.id.rcv_finishBill);
